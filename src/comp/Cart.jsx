...
import { cartTotal, decreaseItemQuantity, deleteCart, increaseItemQuantity, removeAllCart } from "../features/cart/cartSlice";
                    ...
                    
                    {
                       CartData.length === 0 ? "No Data Found..😕" :  CartData.map((value,index)=>(
                        ...
                        <MDBCol md="3" lg="3" xl="3" className="d-flex align-items-center">
                          ...
                          <MDBInput type="number"  defaultValue={value.quantity} size="sm" />
